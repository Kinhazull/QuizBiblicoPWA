...
export type AppEnv = { DB: D1Database; BOOTSTRAP_SECRET?: string; LOCAL_LAN_DEVELOPMENT?: string; QUIZ_OUTBOX_BATCH_LIMIT?: string; QUIZ_LEGACY_FALLBACK_ENABLED?: string; AI?: { run(model:string,input:Record<string,unknown>):Promise<any> } };
