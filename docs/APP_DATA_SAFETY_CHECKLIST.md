...
O produto adota `ADULTS_ONLY_18_PLUS`: cadastro e reaceitação exigem declaração explícita de 18 anos ou mais, sem coleta de data de nascimento. Não é destinado a crianças ou adolescentes e não deve aderir ao Families. O proprietário/revisor ainda deve reconciliar humanamente as respostas vigentes do Play Console sobre coleta, prestadores, retenção, exclusão e processamento internacional; esta matriz não deve ser copiada cegamente.
