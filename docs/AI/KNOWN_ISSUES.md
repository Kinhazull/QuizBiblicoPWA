...
| KI-003 | Jurídico e licenças | Release blocker humano | ACF/Almeida completas e derivados foram retirados da árvore ativa. Restam purge histórico, uso futuro dessas traduções, citações públicas, aprovação dos documentos 18+ e Data Safety. A autoria interna dos acervos foi declarada. |
...
| KI-015 | LGPD/documentos v2 | Release blocker jurídico | Controlador, contato, `ADULTS_ONLY_18_PLUS`, reaceitação versionada, URL de exclusão, ausência de exclusão por inatividade e matriz técnica estão resolvidos; ainda aprovar identidade/endereço se exigidos, bases/prazos, mecanismo internacional, Termos e Privacidade v2. |
