...
- 27.7.3 RC Final: `DONE`; a baseline formal permanece `2.0.0-rc.1`, está em `FEATURE_FREEZE`, distingue o SHA do repositório RC do SHA runtime já promovido e possui checklist humana para a 27.7.4. Os gates locais finais passaram: `test:all` 285/285, Playwright 100 aprovados/4 ignorados, PWA 10/10, typecheck, lint, build 66/66 páginas, Pages Functions e Worker dry-run. 27.7.4 é `NEXT`.
