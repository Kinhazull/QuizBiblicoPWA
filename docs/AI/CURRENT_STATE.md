...
- 27.7.5 Correções e Revalidação: `IN_PROGRESS / TECHNICAL_GATES_COMPLETE`. Layout, contraste, navegação, assets, superfícies participante/Admin e registro idempotente foram estabilizados; A–E estão concluídos e 27.7.5F é o próximo gate.
