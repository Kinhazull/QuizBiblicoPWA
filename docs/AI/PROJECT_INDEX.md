...
- `docs/PRODUCT/CONTENT_GATE_V2.md` — freeze produtivo, elegibilidade e auditoria de antirrepetição da v2
- `scripts/audit-content-antirepetition.mjs` — simulação determinística e read-only dos horizontes de repetição
- `scripts/generate-content-scale-up-v2-inventory.mjs` — reprodução determinística do inventário editorial
- `content/wordle-scale-up-v2-lot-01.json` — evidência versionada do primeiro lote Wordle posteriormente aprovado e publicado
...
- `content/wordle-scale-up-v2-remaining.json` — fonte versionada dos 877 candidatos Wordle posteriormente revisados e publicados
