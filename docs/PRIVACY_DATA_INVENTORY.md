...
| MFA/TOTP cifrado, IV, versão de chave, passos e recovery codes com hash | segurança administrativa | D1 tabelas 0039 | enquanto MFA/conta existir e histórico necessário; ainda sem prazo aprovado | titular/owner por endpoints restritos; segredo não é exportado | Cloudflare; 0039 promovida e verificada em produção |
