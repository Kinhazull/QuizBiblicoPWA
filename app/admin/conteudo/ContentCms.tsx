...
export function CmsEmptyState() {
  return <div className="cms-state empty"><BrandIcon name="database" /><div><strong>Nenhum conteúdo encontrado</strong><p>Ajuste os filtros ou consulte o banco legado do Quiz.</p></div></div>;
}
