  ...
  return <main className="admin-shell">
    ...
    <form className="round-form" onSubmit={submit}>
      <section className="admin-panel round-basics">
        ...
        {advanced && <div className="advanced-rules"><label>Segundos por pergunta<input name="secondsPerQuestion" type="number" min="15" max="60" defaultValue="20" /></label><label>Tentativas oficiais<input name="officialAttemptLimit" type="number" min="1" max="5" defaultValue="3" /></label><label>Pontos base<input name="basePoints" type="number" min="100" max="1000" defaultValue="400" /></label><label>Pontos por segundo restante<input name="speedPointsPerSecond" type="number" min="0" max="100" defaultValue="40" /></label><label>Bônus por sequência<input name="streakBonus" type="number" min="0" max="300" defaultValue="100" /></label><label>Pontuação mínima no acerto<input name="minimumCorrectPoints" type="number" min="0" max="500" defaultValue="100" /></label><label className="round-checkbox"><input type="checkbox" name="allowPractice" defaultChecked /> Permitir tentativas de prática</label></div>}
