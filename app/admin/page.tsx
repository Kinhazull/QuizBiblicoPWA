...
export default function AdminPage() {
  ...
  async function createInvite(event: React.FormEvent<HTMLFormElement>) {
    ...
    setMessage(response.ok ? "Código criado com sucesso." : "Não foi possível criar o código."); if (response.ok) { form.reset(); await load(); }
  }
