...
export const gameCatalog: readonly PlatformGame[] = [
  ...
  { id: "wordle-biblico", slug: "wordle-biblico", name: "Wordle Bíblico", shortDescription: "Descubra a palavra bíblica usando pistas e tentativas limitadas.", description: "Um desafio de palavras inspirado em personagens, lugares, livros e temas de toda a Bíblia.", objective: "Encontrar a palavra bíblica do desafio com o menor número possível de tentativas.", mechanics: ["Uma palavra fixa neste MVP", "Letras corretas, presentes e ausentes", "Seis tentativas para chegar à resposta"], status: "available", primaryButton: "Jogar", route: "/jogos/wordle-biblico", image: "🔤" },
