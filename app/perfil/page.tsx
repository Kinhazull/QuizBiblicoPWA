...
export default function Profile() {
  ...
  return <main className="profile-shell">
    <header className="profile-heading"><p className="eyebrow">MINHA CONTA</p><h1>{user.nickname || user.displayName}</h1><p>Progresso, preferências e segurança em um só lugar.</p></header>
