...
export default function Profile() {
  ...
  return <main className="profile-shell">
    <header className="profile-heading"><p className="eyebrow">MINHA CONTA</p><h1>Meu perfil</h1><p>Sua identidade, jornada e preferências em um só lugar.</p></header>
    <PlatformProfileOverview displayName={user.nickname || user.displayName} />
    {["owner","admin","leader"].includes(user.role)&&<section className="profile-section"><h2>Verificação em duas etapas</h2><p>Proteja o acesso administrativo com um aplicativo autenticador e códigos de recuperação.</p><a className="secondary" href="/configurar-mfa">CONFIGURAR MFA</a></section>}
