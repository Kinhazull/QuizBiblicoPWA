...
const groups=[
  ...
  {label:"Perguntas",links:[["/admin/perguntas","Acervo"],["/admin/perguntas/ia","Sugestões IA"],["/admin/perguntas/revisao","Revisão"],["/admin/perguntas/colaboracao","Colaboração"],["/admin/perguntas/importar","Importar banco"],["/admin/perguntas/base","Base 100"]]},
