...
import { PlatformHome, type PlatformAchievementData, type PlatformMissionData, type PlatformProgressData } from "./PlatformHome";
...
export default function Home() {
  ...
  return <PlatformHome displayName={user.displayName} journey={journey} achievementData={achievementData} progress={progress} mission={mission} missionLoaded={missionLoaded} remaining={remaining} />;
}
